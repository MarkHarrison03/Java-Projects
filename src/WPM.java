...
public class WPM {
    public static void main(String[] args) throws InterruptedException {
        ...
        Dictionary words = new Dictionary("C:\\Users\\markh\\IdeaProjects\\TypeTest\\src\\WordFileLarge.csv",1, 30);
        ...
        String[] wordsGiven = new String[numOfWords];
            ...
            if(Arrays.equals(typedWordsArray, wordsGiven)) {
                ...
                double WPM = ((typedWords.length() / 5) / seconds);
                System.out.println("WPM IS " + (WPM * 60) + "!");
                System.out.println(typedWordsArray.length + " " + averageWordLength + " " + seconds);
            }else{
                System.out.println("Spelling is incorrect. Fail.");
            }
        }
}
